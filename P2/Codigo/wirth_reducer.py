...
def main(argv):
	wirth_file_name = "wirth.txt"
	reduced_wirth_file_name = "wirth_reduced.txt"
	...
	buffer = ""
	giant_dict = {}
	machines_list = ["Program", "NonemptyJotExpr", "CCExpr", "Expr'"]

	dont_replace_list = machines_list+["epsilon"]
